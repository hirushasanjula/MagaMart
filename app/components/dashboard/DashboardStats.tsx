...
export default async function DashboardStats() {
    const {products, user, order} = await gatData()
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4">
        <Card className="w-[260px]">
          <CardHeader className="flex flex-row items-center gap-8 pb-2">
        ...
        <Card className="w-[250px]">
          <CardHeader className="flex flex-row items-center gap-14 pb-2">
        ...
        <Card className="w-[250px]">
          <CardHeader className="flex flex-row items-center gap-12 pb-2">
